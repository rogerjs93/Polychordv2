...
import { Calendar, Target, Trophy, Flame, TrendingUp } from 'lucide-react';
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-r from-green-400 to-emerald-500 text-white rounded-lg p-4">
          ...
          <p className="text-sm opacity-90">Words Today</p>
        </div>
      ...
      <div className="grid grid-cols-7 gap-2">
        <div className="text-center text-xs text-gray-500 col-span-7 mb-2">Weekly Activity</div>
